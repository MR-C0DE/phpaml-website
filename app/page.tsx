...
const copy = {
  en: {
    ...
    ready: "Ready to build?", next: <>Your next project<br />starts with <code>aml create</code>.</>, installAml: "Install PHPAML",
    features: [
  ...
  fr: {
    ...
    ready: "Prêt à construire ?", next: <>Votre prochain projet<br />commence par <code>aml create</code>.</>, installAml: "Installer PHPAML",
    features: [
...
export function HomePage({ locale }: { locale: "en" | "fr" }) {
  ...
  return <><Header locale={locale} /><main>
    ...
    </div><div className="hero-code"><div className="version-pill"><span /> v1.3.0 · stable</div><div className="terminal-label">01 / QUICK START</div>
